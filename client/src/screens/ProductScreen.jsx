            ...
            <Stack direction={{ base: "column", lg: "row" }} align={{ lg: "flex-start" }}>
              ...
              >
                ...
                <Stack spacing={"5"}>
                  ...
                  <Button colorScheme={"orange"} onClick={addItem} isDisabled={product.stock === 0}>
                    Add to cart
                  </Button>
                  <Stack width={"270px"}>
                ...
                {product.reviews.map((review) => (
                  <Box key={review._id}>
                    <Flex spacing="2px" alignItems={"center"}>
                      <StarIcon color={review.rating >= 1 ? "orange.500" : "gray.200"} />
                    ...
                    <Text fontWeight={"sm"} color={"gray.400"}>
